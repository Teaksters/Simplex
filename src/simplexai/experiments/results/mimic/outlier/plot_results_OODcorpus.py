...
plt.plot(n_inspected, means[0], "-", label="corpus Age x" + str(OOD_scalers[0]), color=colors[1])
...
plt.plot(n_inspected, means[3], "-", label="corpus Age x" + str(OOD_scalers[3]), color=colors[4])
plt.fill_between(n_inspected, means[3] - stds[3], means[3] + stds[3], alpha=0.3, color=colors[4])

plt.plot(n_inspected, means[4], "-", label="corpus Age x" + str(OOD_scalers[4]), color=colors[5])
