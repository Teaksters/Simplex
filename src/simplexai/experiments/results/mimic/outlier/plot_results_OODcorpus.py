...
plt.plot(n_inspected, means[0], "-", label="corpus Age x" + str(c_scalers[0]))
plt.fill_between(n_inspected, means[0] - stds[0], means[0] + stds[0], alpha=0.3)

plt.plot(n_inspected, means[1], ".", label="corpus Age x" + str(c_scalers[1]))
plt.fill_between(n_inspected, means[1] - stds[1], means[1] + stds[1], alpha=0.3)

plt.plot(n_inspected, means[2], "--", label="corpus Age x" + str(c_scalers[2]))
plt.fill_between(n_inspected, means[2] - stds[2], means[2] + stds[2], alpha=0.3)

plt.plot(n_inspected, means[3], "-.", label="corpus Age x" + str(c_scalers[3]))
plt.fill_between(n_inspected, means[3] - stds[3], means[3] + stds[3], alpha=0.3)

plt.plot(n_inspected, means[4], "-.", label="corpus Age x" + str(c_scalers[4]))
