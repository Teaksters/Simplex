...
plt.title(titles[0])
plt.tight_layout()
plt.savefig(safe_path / (titles[0] + '.jpg'))
...
plt.title(titles[2])
plt.tight_layout()
plt.savefig(safe_path / (titles[1] + '.jpg'))
...
plt.title(titles[2])
plt.tight_layout()
plt.savefig(safe_path / (titles[2] + '.jpg'))
...
plt.title(titles[3])
plt.tight_layout()
plt.savefig(safe_path / (titles[3] + '.jpg'))
...
plt.title(titles[4])
plt.tight_layout()
plt.savefig(safe_path / (titles[4] + '.jpg'))
...
plt.title(titles[5])
plt.tight_layout()
plt.savefig(safe_path / (titles[5] + '.jpg'))
...
plt.title(titles[6])
plt.tight_layout()
plt.savefig(safe_path / (titles[6] + '.jpg'))
...
plt.title(titles[7])
plt.tight_layout()
plt.savefig(safe_path / (titles[7] + '.jpg'))
...
plt.title(titles[8])
plt.tight_layout()
plt.savefig(safe_path / (titles[8] + '.jpg'))
...
plt.title(titles[9])
plt.tight_layout()
plt.savefig(safe_path / (titles[9] + '.jpg'))
...
plt.title(titles[10])
plt.tight_layout()
plt.savefig(safe_path / (titles[10] + '.jpg'))
...
plt.title(titles[11])
plt.tight_layout()
plt.savefig(safe_path / (titles[11] + '.jpg'))
